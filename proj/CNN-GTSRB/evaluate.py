...
parser.add_argument('--outfile', type=str, default='pred_test.csv', metavar='D',
...
test_dir = "../test"# args.data + '/test_images'
...
transforms = [data_grayscale,data_jitter_hue,data_jitter_brightness,data_jitter_saturation,data_jitter_contrast,data_rotate,data_hvflip,data_shear,data_translate,data_center]
output_file = open(args.outfile, "w")
output_file.write("Id,ClassId\n")
